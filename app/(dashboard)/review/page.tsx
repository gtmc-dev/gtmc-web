  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 px-6">
      <div className="border-tech-main/40 relative border-b pb-6">
        ...
        "></div>
        <h1 className="
          text-tech-main-dark flex items-center text-2xl font-bold
          tracking-tight uppercase
          md:text-4xl
        ">
          <span className="
            bg-tech-main/20 border-tech-main/40 mr-4 size-4 border
          "></span>
          REVIEW HUB
        </h1>
        <p className="
          text-tech-main/80 mt-3 flex items-center font-mono text-xs
          tracking-widest
          sm:text-sm
        ">
          <span className="bg-tech-main mr-2 size-2 animate-pulse rounded-full"></span>
      ...
      <div className="grid grid-cols-1 gap-6">
        {openPRs.length === 0 ? (
          <div className="
            border-tech-main/40 group relative border border-dashed bg-white/30
          ...
          ">
            ...
            "></div>
            <h2 className="
              text-tech-main/50 relative z-10 font-mono text-lg tracking-widest
              uppercase
            ">
          ...
          openPRs.map((pr) => (
            <BrutalCard
              key={pr.id}
              className="
                border-tech-main/40 group relative flex flex-col items-start
                justify-between space-y-4 border bg-white/80 p-6
                backdrop-blur-sm
              ...
              <div className="
                ...
                translate-px border-r-2 border-b-2 opacity-0 transition-opacity
                group-hover:opacity-100
              "></div>
              ...
              <div className="relative z-10 flex-1">
                ...
                <h3 className="
                  text-tech-main-dark border-tech-main/40 mb-2 border-l-2 pl-3
                ...
                <p className="
                  bg-tech-main/5 border-tech-main/20 text-tech-main ml-3
                  inline-flex items-center border px-2 py-1 font-mono text-xs
                ">
                  <span className="bg-tech-main mr-2 size-1.5"></span>{" "}
                  TARGET: {pr.head.ref}
                </p>
              </div>
